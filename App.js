    ...
    <div className="header">
      <div>
        <img
          ...
          alt="app-log"
          src="https://thumbs.dreamstime.com/b/burger-logo-hamburger-design-minimal-style-cheeseburger-plate-emblem-label-fresh-tasty-menu-restaurant-cafe-sandwich-369913617.jpg"
        ></img>
      </div>
...
const ResCards = ({ resName, cuisines, costForTwo }) => {
  return (
    <div className="res-card">
      <div>
        <img
          className="res-img"
          src="https://www.rewardsnetwork.com/wp-content/uploads/2016/12/IndianFood_Main.jpg"
          alt="restuarant logo"
        />
      </div>
        ...
        {restuarantList.map((res) => {
          ...
          return (
            <ResCards
              ...
              costForTwo={resData?.costForTwoString}
            />
          );
        })}
      </div>
...
const Footer = () => {
  return <div>Hello I am your footer</div>;
};
const AppLayout = () => {
  return (
    <div>
